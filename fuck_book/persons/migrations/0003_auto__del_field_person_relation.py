...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Person.relation'
        db.delete_column(u'persons_person', 'relation_id')


    def backwards(self, orm):
        # Adding field 'Person.relation'
        db.add_column(u'persons_person', 'relation',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='related user', unique=True, null=True, to=orm['persons.Person'], blank=True),
                      keep_default=False)
