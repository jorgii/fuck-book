...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'persons_person', (
            ...
            ('relation', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='related user', unique=True, null=True, to=orm['persons.Person'])),
            ('display_periodical_notification', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('display_tip_notification', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('display_difference_notification', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('periodical_notification_period', self.gf('django.db.models.fields.IntegerField')(default=14)),
            ('tip_notification_period', self.gf('django.db.models.fields.IntegerField')(default=7)),
            ('difference_notification_period', self.gf('django.db.models.fields.IntegerField')(default=30)),
        ))
        db.send_create_signal(u'persons', ['Person'])

        # Adding M2M table for field preferred_poses on 'Person'
        m2m_table_name = db.shorten_name(u'persons_person_preferred_poses')
        ...
        db.create_unique(m2m_table_name, ['person_id', 'poseslist_id'])

        # Adding M2M table for field preferred_places on 'Person'
        m2m_table_name = db.shorten_name(u'persons_person_preferred_places')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('person', models.ForeignKey(orm[u'persons.person'], null=False)),
            ('placeslist', models.ForeignKey(orm[u'hardcoded_models.placeslist'], null=False))
        ))
        db.create_unique(m2m_table_name, ['person_id', 'placeslist_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field preferred_poses on 'Person'
        db.delete_table(db.shorten_name(u'persons_person_preferred_poses'))

        # Removing M2M table for field preferred_places on 'Person'
        db.delete_table(db.shorten_name(u'persons_person_preferred_places'))
